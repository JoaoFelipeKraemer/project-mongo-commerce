...
- `git clone git@github.com:tryber/sd-025-b-mongodb-commerce.git`.

- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-025-b-mongodb-commerce`
...
### 14 - Crie uma query que retorne todos os lanches que possuem _picles_ em seus ingredientes e mostre apenas os `3` primeiros itens contidos no array `valoresNutricionais`
